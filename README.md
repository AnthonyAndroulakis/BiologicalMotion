...
![input video (converted to gif here for viewing purposes)](https://github.com/AnthonyAndroulakis/BiologicalMotion/blob/master/sampletests/sample.gif){:height="200px" width="400px"}
