...
## Quickstart (short-and-sweet) (Requirement: Linux OS):
...
5) To Generate Biological Motion txt Files: `python3 -c "import vid2txt; vid2txt.main('filename.mp4 --no-duration')"` where filename is your video file name      
*(if you'd like to add-in duration info, simply run `python3 -c "import vid2txt; vid2txt.main('filename.mp4')"`)*
